...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  try {
    ...
    if (route[0] === "lookup") return run(req, res, () => import("../../server/api/scopes/lookup.js"));
    if (route[0] === "summaries") return run(req, res, () => import("../../server/api/scopes/summaries.js"));
